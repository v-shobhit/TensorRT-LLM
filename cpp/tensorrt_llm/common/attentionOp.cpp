...
int AttentionOp::initialize() noexcept
{
    ...
    if (mFP8ContextFMHA)
    {
        ...
        TLLM_CHECK_WITH_INFO(mSM == 89 || mSM == 90 || mSM == 100 || mSM == 103 || mSM == 120,
            "FP8 FMHA can only be enabled on sm_89, sm_90, sm_100, sm_103 or sm_120.");
    }
    ...
    TLLM_CHECK_WITH_INFO(
        !mFuseFp4Quant || (mSM == 100 || mSM == 103), "fuse_fp4_quant only supports SM100 or SM103 devices.");
